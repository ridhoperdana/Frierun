...
/**
 * Created by RIDHO on 12/15/2016.
 */
...
public class Direction extends AsyncTask<String, Void, Document>{
    ...
    public Direction(Handler handler, LatLng start, LatLng end, String mode) {
        this.start = start;
        this.end = end;
        this.mode = mode;
    ...
    protected void onPostExecute(Document result) {
        if (result != null) {
            Log.d("oke", "---- GMapV2DirectionAsyncTask OK ----");
            Message message = new Message();
            message.obj = result;
            handler.dispatchMessage(message);
        } else {
            Log.d("gagal", "---- GMapV2DirectionAsyncTask ERROR ----");
        }
    }
