...
public class LoginActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(LoginActivity.this, TrackLocationActivity.class));
            finish();
        }
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if (password.length() < 6) {
                                        inputPassword.setError("password kurang panjang");
                                    } else {
                                        Toast.makeText(LoginActivity.this, "login gagal", Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Intent intent = new Intent(LoginActivity.this, TrackLocationActivity.class);
